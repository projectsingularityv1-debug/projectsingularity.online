const translations = {
    en: {
        ...
        "overview.stats.package": "Current Package",
        "overview.stats.time": "Time in account",
        "overview.stats.member_since": "Member Since",
        
        "personal.title": "Personal Information",
        "personal.subtitle": "Manage details connected to your account",
        "personal.username": "Username",
        "personal.email": "Email Address",
        "personal.country": "Country / Region",
        "personal.country_empty": "Not detected yet",
        ...
        "security.password_desc": "Keep your account secure",
        ...
        "keyhistory.table.key": "Redeemed License Key",
        "keyhistory.table.package": "Current Package",
        "keyhistory.table.status": "Status",
        "keyhistory.table.received": "Received",
        "keyhistory.table.expires": "Expires",
        "keyhistory.table.created": "Created At",
        "keyhistory.status.active": "Active",
        "keyhistory.status.revoked": "Revoked",
        "keyhistory.type.private": "Private Key",
        "keyhistory.type.public": "Public Key",
    ...
    th: {
        ...
        "overview.stats.package": "แพ็กเกจปัจจุบัน",
        "overview.stats.time": "เวลาในบัญชี",
        "overview.stats.member_since": "เป็นสมาชิกตั้งแต่",
        ...
        "personal.country": "ประเทศ / ภูมิภาค",
        "personal.country_empty": "ยังตรวจไม่พบ",
        "personal.created": "เป็นสมาชิกตั้งแต่",
        "personal.edit": "แก้ไข",
        ...
        "security.password_desc": "รักษาบัญชีของคุณให้ปลอดภัย",
        ...
        "keyhistory.table.key": "แลกคีย์ไลเซนส์แล้ว",
        "keyhistory.table.package": "แพ็กเกจปัจจุบัน",
        "keyhistory.table.status": "สถานะ",
        "keyhistory.table.received": "รับแล้ว",
        "keyhistory.table.expires": "หมดอายุ",
        "keyhistory.table.created": "สร้างเมื่อ",
        "keyhistory.status.active": "ใช้งานอยู่",
        "keyhistory.status.revoked": "ถูกเพิกถอน",
        "keyhistory.type.private": "คีย์ส่วนตัว",
        "keyhistory.type.public": "คีย์สาธารณะ",
